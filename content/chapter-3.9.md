# Chapter 3.9 - Documentation Consolidation Plan
...
### 3.9.2 Source Material to Consolidate
...
| Chapter 3.8 | Artifact primitives, lifecycle, workspace manifestation, data model | Chapter 3 artifacts |
...
### 3.9.3 Source Preservation Register
...
### 3.9.5 Conflicts to Resolve Into Final Decisions
...
8. Keep Chapter 3.8 as the final artifact ontology and lifecycle chapter.
9. Remove implementation-plan material from the final Chapter 3 reader path.
10. Keep Chapter 3.9 as a temporary consolidation guide until the final chapter set is stable.
11. Keep Chapter 4 as the only reader-facing implementation-plan chapter.

### 3.9.7 Chapter 4 Role
